...
- [Chat View](./ui/chat-view.md)
- [Tab Bar](./ui/tab-bar.md)
- [Status Bar](./ui/status-bar.md)
- [Command Palette](./ui/command-palette.md)

# Keyboard Shortcuts

- [Quick Reference](./shortcuts/quick-reference.md)
- [Global](./shortcuts/global.md)
- [Chat Mode](./shortcuts/chat.md)
- [Scrolling](./shortcuts/scrolling.md)
- [Sidebar](./shortcuts/sidebar.md)
- [Dialogs](./shortcuts/dialogs.md)
...
- [Tool Paths](./configuration/tool-paths.md)
- [Themes](./configuration/themes.md)
  - [Built-in Themes](./configuration/themes/builtin.md)
  - [Custom Themes](./configuration/themes/custom.md)
  - [VS Code Migration](./configuration/themes/vscode-migration.md)
...
- [Branch Status](./git/branch-status.md)
- [PR Tracking](./git/pr-tracking.md)
...
- [Theme Properties](./reference/theme-properties.md)
